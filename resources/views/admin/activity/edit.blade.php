...
@section("content")
    ...
    <form class="form-horizontal" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="title" placeholder="活动标题" name="title" value="{{$activity->title}}">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="date"  class="form-control" placeholder="活动结束时间" name="start_time" value="{{$activity->start_time}}">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="date"  class="form-control" placeholder="活动结束时间" name="end_time" value="{{$activity->end_time}}">
            </div>
        </div>
