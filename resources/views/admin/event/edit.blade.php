...
@section("content")
    <div class="box-header with-border" >
        <i class="box-title" ><font size="6" color="#8a2be2" >抽奖活动修改</font></i>
    </div>
    ...
    <form class="form-horizontal" action="" method="post">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" name="title" class="form-control" placeholder="名称" value="{{$event->title}}">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" name="content" class="form-control" placeholder="详情" value="{{$event->content}}">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" name="num" class="form-control" placeholder="报名人数限制" value="{{$event->num}}">
            </div>
        </div>
