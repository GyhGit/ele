...
@section("content")
    <form class="form-horizontal" method="post" enctype="multipart/form-data" action="">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input name="status" type="radio" value="1"  @if (old("status")==1) checked @endif>上架
                <input name="status" type="radio" value="0" @if(old("status")==1) checked @endif>下架
    ...
    <script>
        ...
        jQuery(function () {
            ...
            uploader = WebUploader.create({
                ...
                // 文件接收服务端。
                server: '{{route("shop.dishis.upload")}}',
