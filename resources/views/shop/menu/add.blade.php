...
<div class="box-header with-border" >
    ...
    <form class="form-horizontal" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="type_accumulation" placeholder="菜品编号" name="type_accumulation" value="{{old("type_accumulation")}}">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <textarea rows="3" class="form-control"  name="description" placeholder="分类描述"></textarea>
        ...
        <div class="form-group">
            <label for="status" class="col-sm-2 control-label">分类是否默认</label>
            <div class="col-sm-10">
